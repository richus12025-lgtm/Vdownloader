...
app.post('/api/download', async (req, res) => {
    ...
    try {
        ...
        // Add extra extractor arguments to improve YouTube compatibility
        const command = `yt-dlp -j --extractor-args "youtube:player_js_variant=tv" --no-warnings --no-playlist "${url}"`;
